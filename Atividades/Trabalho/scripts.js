...
const DOM = {
    transactionsContainer: document.querySelector('#column'),

    addTransaction(transaction, index) {
        const div = document.createElement('div');
        div.classList.add('card1');
        div.innerHTML = DOM.innerHTMLTransaction(transaction, index);
        div.dataset.index = index;
        // tr.dataset.index = index 

        DOM.transactionsContainer.appendChild(div)
        DOM.transactionsContainer.appendChild(document.createElement('br'))
    ...
    innerHTMLTransaction(transaction, index) {
        ...
        const html = `
            <img class='transaction' src='./assets/${CSSclass}.svg' >
